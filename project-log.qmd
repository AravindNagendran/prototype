...
## 2026-07-29
- Updated the Wikidata Item Profile to Q138651552 (Martina Kresta).
- Executed the notebook and regenerated the SPARQL profile.
- Added and verified the Wikidata network graph.
- Added the Exhibition Data Model page.
- Added the Artist Data Model page.
- Added ORCID metadata to the project.
- Created a CITATION.cff file.
- Created a Quarto page describing the Wikidata item.
- Updated the navigation menu.
- Rendered the Quarto project successfully.
...
- Added notebook-backed item profile page for Wikidata item `Q138651552`.
